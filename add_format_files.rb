...
# Files to add
files_to_add = [
  'FormatFinder/Features/Formats/AnimatedFormatExplainer.swift',
  'FormatFinder/Features/Formats/EnhancedFormatsGrid.swift',
  'FormatFinder/Models/ExtendedGolfFormats.swift'
]
